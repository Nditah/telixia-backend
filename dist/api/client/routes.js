 ...
 */
router.get("/clients", [_authorization.checkAuth, _authorization.isValidAdmin], _controller.fetchRecord);
 ...
 */
router.post("/clients", _controller.createRecord);
 ...
 * @apiError 401 master access only.
 */
router.put("/clients/:recordId", [_authorization.checkAuth], _controller.updateRecord);
 ...
 * @apiError 401 master access only.
 */
router.delete("/clients/:recordId", [_authorization.checkAuth, _authorization.isValidAdmin], _controller.deleteRecord);
 ...
 * @apiError 404 Client not found.
 */
router.post("/clients/login", _controller.login);
