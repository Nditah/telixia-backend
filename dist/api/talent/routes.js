 ...
 */
router.get("/talents", [_authorization.checkAuth, _authorization.isValidAdmin], _controller.fetchRecord);
 ...
 */
router.post("/talents", _controller.createRecord);
 ...
 * @apiError 401 master access only.
 */
router.put("/talents/:recordId", [_authorization.checkAuth], _controller.updateRecord);
 ...
 * @apiError 401 master access only.
 */
router.delete("/talents/:recordId", [_authorization.checkAuth, _authorization.isValidAdmin], _controller.deleteRecord);
 ...
 * @apiError 404 Talent not found.
 */
router.post("/talents/login", _controller.login);
